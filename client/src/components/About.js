    	...
    	<div className="row">
    	    <div className=" about-content animated fadeIn scrollable" >
    	    	<h1 className="animated fadeIn one">about</h1>
    	       	<div className="about-me" style={{transform: "translateY(0px) translateZ(0px)", marginTop: "20px"}}>
    	       		...
    	       		<div className="Synopsis-highlightLine five" style={{transform: "matrix(1, 0, 0, 1, 0, 0)"}}></div>
  	      	...
  	      	<div className="perspective-container">
  		        <div className="zero photo-about animated fadeIn" style={{transform:"translateY(0px) translateZ(0px)"}}>
  		        	...
  		        	<div className="about-info">
  		        		<h3 className="about-info-name animated fadeInUp up-one">Rasheem Gilbert </h3>
  		        		<div className="about-info-contact">
  		        			<h4 className="animated fadeInUp up-two"> Full Stack Developer,  & Music Lover</h4>
  		        			<p className="animated fadeInUp up-three">Where ever the wind blows in Boston, Ma</p>
  		        			<a href="./contact" className="animated fadeInUp up-four">Contact Me</a>
  		        		</div>
  		        	</div>
  		        </div>
  	      	</div>
